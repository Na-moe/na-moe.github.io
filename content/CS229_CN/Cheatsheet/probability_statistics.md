...
|              |                            定义                             |                                                                                                       形式                                                                                                       |
| ------------ | :-------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| **随机变量的变换**  | 设 $X$ 和 $Y$ 被某个函数联系在一起，记 $f_X, f_Y$ 分别为 $X$ 和 $Y$ 的分布函数，有 |                                                                     $$f_{Y}(y)=f_{X}(x)\lvert {\frac{\mathrm{d}x}{\mathrm{d}y}} \rvert $$                                                                      |
...
| **切比雪夫不等式**  |        令 $X$ 为随机变量，期望值为 $\mu$. 对于 $k, \sigma>0$, 有        |                                                                            $$P(\lvert X-\mu \rvert \ge k\sigma)\le \frac{1}{k^2}$$                                                                             |
