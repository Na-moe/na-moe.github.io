...
|          |                                                定义                                                |                                                                                          形式                                                                                          |                                                  注释                                                   |
| -------- | :----------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------: |
| **向量**   |      记 $\boldsymbol{x} \in \mathbb{R}^n$ 为一个 $n$ 维向量，其中 ${x}_{i} \in \mathbb{R}$ 是第 $i$ 维元素      |                                      $$\boldsymbol{x} = \begin{pmatrix}\ x_1\ \\ \ x_2\ \\ \ \vdots\ \\ \ x_n\ \end{pmatrix} \in \mathbb{R}^n$$                                      |                         向量 $\boldsymbol{x}$ 也可视为一个 $n \times 1$ 维的矩阵，也常被称为列向量                         |
