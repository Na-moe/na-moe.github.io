...
> 
> $$\begin{align*}\frac{\mathrm{d}}{\mathrm{d}t}\psi_t(x_0)&\overset{(3)}{=} \frac{\mathrm{d}}{\mathrm{d}t} \big( \exp(-\theta t) x_0 \big) \\&\overset{(i)}{=} -\theta \exp(-\theta t) x_0 \\&\overset{(3)}{=} -\theta \psi_t(x_0) = u_t(\psi_t(x_0)),\end{align*}$$
> 
